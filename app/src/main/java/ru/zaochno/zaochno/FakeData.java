...
public class FakeData {
    ...
    static {
        ...
        tests.add(new Test("test2",2,questions,"Короткое описание теста номер 2 Короткое описание теста номер 2 Короткое описание теста номер 2 Короткое описание теста номер 2" +
                "Короткое описание теста номер 2 Короткое описание теста номер 2 Короткое описание теста номер 2 Короткое описание теста номер 2" +
                "Короткое описание теста номер 2 Короткое описание теста номер 2 Короткое описание теста номер 2 Короткое описание теста номер 2",new Date(),null,0));
